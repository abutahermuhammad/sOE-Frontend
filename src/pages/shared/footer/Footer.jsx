...
const Footer = () => {
  return (
    <div>
      <footer className="footer md:flex justify-between p-10 bg-[#000324] text-[#B0ABDF]">
      <div className="md:flex-col justify-center">
    <div><img src="/public/soe.png" alt="" /></div>
    <p className="text-center">School Of Excellence <br/>Providing reliable tech since 1992</p>
  </div > 
  <nav>
