...
const MentorsCard = () => {
  return (
      ...
      <div className="card w-80 bg-gradient-to-t from-[#020957]  to-[#050936]  text-white shadow-[#05092d] shadow-lg hover:border border-blue-500 transition group ">
  ...
  <div className="card-body items-center text-center font-balooda">
